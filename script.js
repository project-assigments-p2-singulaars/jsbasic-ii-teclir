...
const area1 = calcularAreaRectangulo(5, 3);
console.log("El área del rectángulo con ancho 5 y alto 3 es:", area1);

const area2 = calcularAreaRectangulo(8, 4);
console.log("El área del rectángulo con ancho 8 y alto 4 es:", area2);

const area3 = calcularAreaRectangulo(10, 6);
console.log("El área del rectángulo con ancho 10 y alto 6 es:", area3);
